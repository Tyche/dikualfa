...
dmserver : comm.o act.comm.o act.informative.o act.movement.o act.obj1.o \
	...
	handler.o db.o interpreter.o utility.o spec_assign.o shop.o \
	limits.o mobact.o fight.o modify.o weather.o spell_parser.o \
	spells1.o spells2.o reception.o constants.o spec_procs.o signals.o \
...
dmserver : comm.c act.comm.c act.informative.c act.movement.c act.obj1.c \
	...
	$(CC) -o dmserver $(CFLAGS) comm.o act.comm.o act.informative.o \
	...
	spec_assign.o shop.o limits.o mobact.o fight.o modify.o weather.o \
	spells1.o spells2.o spell_parser.o reception.o constants.o \
